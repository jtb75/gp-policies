...
threshold_ns := globals.vendor_key_warning_days * 24 * 60 * 60 * 1000000000
...
expectedConfiguration := sprintf("Vendor access keys should be rotated at least every %d days.", [globals.vendor_key_warning_days])
